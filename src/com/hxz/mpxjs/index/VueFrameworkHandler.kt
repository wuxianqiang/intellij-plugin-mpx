...
import com.hxz.mpxjs.lang.html.parser.VueStubElementTypes
import com.hxz.mpxjs.libraries.componentDecorator.isComponentDecorator
import com.hxz.mpxjs.model.getSlotTypeFromContext
import com.hxz.mpxjs.model.hasSrcReference
import com.hxz.mpxjs.model.tryResolveSrcReference
import com.hxz.mpxjs.model.source.*
import com.hxz.mpxjs.model.source.VueComponents.Companion.isStrictDefineComponentOrVueExtendCall
import com.hxz.mpxjs.model.typed.VueTypedEntitiesProvider
import com.hxz.mpxjs.types.VueCompositionPropsTypeProvider
...
class VueFrameworkHandler : FrameworkIndexingHandler() {
  ...
  companion object {
    ...
    const val TYPED_COMPONENT_MARKER = "Mpx Typed Component"
    ...
    private const val METHOD_NAME_USER_STRING = "vmnmpx"
  ...
  private fun isDefineComponentOrVueExtendCall(callNode: ASTNode): Boolean =
    checkCallExpression(callNode) { referenceName, hasQualifier ->
      (!hasQualifier && (referenceName == DEFINE_COMPONENT_FUN || referenceName == DEFINE_PAGE_FUN))
