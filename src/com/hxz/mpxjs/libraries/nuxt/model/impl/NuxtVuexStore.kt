...
import com.hxz.mpxjs.codeInsight.collectMembers
import com.hxz.mpxjs.codeInsight.objectLiteralFor
import com.hxz.mpxjs.libraries.vuex.VuexUtils
import com.hxz.mpxjs.libraries.vuex.VuexUtils.MODULES
  ...
  companion object {
    ...
    private fun getJSFiles(dir: PsiDirectory): Map<String, JSFile> {
      ...
      dir.processChildren { file ->
        if (file is JSFile) {
          val name = JSFileReferencesUtil.getFileNameWithoutExtension(file.name,
                                                                      IMPLICIT_EXTENSIONS)
