...
import com.hxz.mpxjs.lang.typescript.service.protocol.VueTypeScriptServiceProtocol
      ...
      return ReadAction.compute<List<JSAnnotationError>, Throwable> {
        ...
        return@compute errors.filter {
          it is JSLanguageServiceAnnotationResult && (
            (regularModuleRangeFilter?.invoke(it) == true && !skipScriptSetupError(it)) || (scriptModuleRangeFilter?.invoke(it) == true && !skipScriptSetupError(it)))
        }
      }
    }
