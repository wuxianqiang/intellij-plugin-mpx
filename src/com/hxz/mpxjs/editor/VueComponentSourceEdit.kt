...
import com.hxz.mpxjs.web.VueWebSymbolsQueryConfigurator.Companion.KIND_VUE_TOP_LEVEL_ELEMENTS
...
class VueComponentSourceEdit private constructor(private val component: Pointer<VueSourceComponent>) {
  ...
  fun getOrCreateScriptScope(): JSExecutionScope? {
    ...
    val newScriptTag = PsiFileFactory.getInstance(file.project)
      .createFileFromText("dummy.mpx", VueFileType.INSTANCE, "<script>\n</script>")
...
//      ?.firstOrNull() != null
    ...
    val dummyFile = PsiFileFactory.getInstance(project).createFileFromText("dummy.mpx", VueFileType.INSTANCE, text)
